...
public class RoomController {
    ...
    @GetMapping("pageItem")
    public ResponseData<IPage<RoomItemVo>> pageItem(@RequestParam long current, @RequestParam long size, RoomQueryVo queryVo) {
    ...
    public ResponseData<IPage<RoomItemVo>> pageItemByApartmentId(@RequestParam long current, @RequestParam long size, @RequestParam Long id) {
        return ResponseData.ok();
    }
}
